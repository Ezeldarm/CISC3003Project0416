  ...
  <aside class="sidebar">
    <nav class="side-nav">
      <ul class="nav-list">
        ...
        <li class="nav-item">
          <a href="cities.html" class="nav-link">
      ...
      <div>
        ...
        <section class="hero">
          <div class="container">
            ...
            <!--<img src="./assets/images/hero.jpg" class="hero-banner" alt="hero">-->
            ...
            <div class="property-list">
              ...
              <div class="card">
                ...
                <div class="card-content">
                  ...
                  <h3>
                    <a href="#" class="title-small card-title">Hong Kong SAR</a>
                  </h3>
  
                  <address class="body-medium card-text">
                    Disneyland, Victoria Peak, Ocean Park...
                  </address>
              ...
              <div class="card">
                ...
                <div class="card-content">
                  ...
                  <h3>
                    <a href="#" class="title-small card-title">Macao SAR</a>
                  </h3>
  
                  <address class="body-medium card-text">
                    Ruins of St. Paul's, Grand Lisboa...
                  </address>
              ...
              <div class="card">
                ...
                <div class="card-content">
                  ...
                  <h3>
                    <a href="#" class="title-small card-title">Shanghai, China</a>
                  </h3>
  
                  <address class="body-medium card-text">
                    The Bund, Oriental Pearl Tower, Yu Garden...
                  </address>
              ...
              <div class="card">
                ...
                <div class="card-content">
                  ...
                  <h3>
                    <a href="#" class="title-small card-title">Beijing, China</a>
                  </h3>
        ...
        <section class="section feature" aria-labelledby="feature-label">
          <div class="container">
            ...
            <div class="feature-content">
                <p class="title-small feature-text">
                    Article
                </p>
  
              <h2 class="headline-large" id="feature-label">
                China Travel 101: Essential Prep Before You Go
              </h2>
      ...
      <div class="footer-bottom">
        <div class="container">
          ...
          <p class="copyright body-medium">
            &copy; 2025 WebMaster Partners. All rights reserved. CISC3003 Web Programming - 2025: Pair 12 DC328536 ZHONG YUZHANG | DC326958 XIE YI | Pair 10 DC326264 CHEANG NGOU HIN | DC325022 PAN YANGSHEN
          </p>
