    ...
    <div class="footer-top">
        <div class="container">
            ...
            <nav class="footer-nav" aria-labelledby="nav-label-3">
                ...
                <ul class="footer-list">
                    <li><a href="#" class="body-medium footer-link">CISC3003-2025T2@um.edu.com</a></li>
                    <li>
                    ...
                    <li>
                        <ul class="social-list">
                            ...
                            <li><a href="#" class="social-link"><img src="./assets/images/twitter.svg" alt="twitter"></a></li>
                            <li><a href="#" class="social-link"><img src="./assets/images/insta.svg" alt="instagram"></a></li>
                        </ul>
                    </li>
                </ul>
            </nav>
